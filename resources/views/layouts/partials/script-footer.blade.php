...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        // Check if there is a toast message in the session
        @if (session('toast_message'))
            // Show the toast
            var toast = new bootstrap.Toast(document.getElementById('toastNotification'));
            toast.show();

            // Set toast color based on session color value
            var toastBody = document.getElementById('toastBody');
            @if (session('toast_color') === 'info')
                toastBody.classList.add('bg-info');
            @elseif (session('toast_color') === 'success')
                toastBody.classList.add('bg-success');
            @elseif (session('toast_color') === 'danger')
